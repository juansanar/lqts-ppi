...
case# defiing description factors
...
#  geom_rect(aes(xmin = 10, xmax = 852, ymin = 1-0.05, ymax = 1+0.05, fill = "MBD"), colour = "black") +
  ...
  geom_point(aes(x = 1458, y = 0.84), size=3, color="red", fill=alpha("orange", 0.3), alpha=0.7, shape=21, stroke=1.5) +   geom_segment(aes(x = 646, xend = 646, y = 1.03, yend = 1.15), size = 0.75) +
  ...
  geom_point(aes(x = 990, y = 1.16), size=3, color="red", fill=alpha("orange", 0.3), alpha=0.7, shape=21, stroke=1.5) +   geom_segment(aes(x = 1283, xend = 1283, y = 0.97, yend = 0.85), size = 0.75) +
  geom_point(aes(x = 1283, y = 0.84), size=3, color="red", fill=alpha("orange", 0.3), alpha=0.7, shape=21, stroke=1.5) +   geom_segment(aes(x = 1988, xend = 1988, y = 1.03, yend = 1.15), size = 0.75) +
  geom_point(aes(x = 1988, y = 1.16), size=3, color="red", fill=alpha("orange", 0.3), alpha=0.7, shape=21, stroke=1.5) +
  geom_segment(aes(x = 1516, xend = 1516, y = 1.03, yend = 1.15), size = 0.75) +
  geom_point(aes(x = 1516, y = 1.16), size=3, color="red", fill=alpha("orange", 0.3), alpha=0.7, shape=21, stroke=1.5) +
  ...
  geom_segment(aes(x = 3570, xend = 3570, y = 1.03, yend = 1.15), size = 0.75) +
  geom_point(aes(x = 3570, y = 1.16), size=3, color="red", fill=alpha("orange", 0.3), alpha=0.7, shape=21, stroke=1.5) +
  theme_classic() +
