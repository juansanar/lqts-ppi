...
All text below correspond to the above workflow and only small changes were made to adapt it to the dataset used for the main pruporse of this Rmarkdown document (analyzing cardiac neural crest cells microaaray data from Dai et al. 2012 [*E-GEOD-41179*] and cardiac outflow tract cells from Robrini et al., 2015 [*E-GEOD-64556*])
...
## Exploring expression values g LQTS genes
...
### Plotting expression valus with ggplot
...
df_wt_lqts %>% 
  ...
  labs(title = "Transcript log2 expression values of\nLQTS associated genes in cardiac neural crest cells", 
