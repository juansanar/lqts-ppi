...
All text below correspond to the above workflow and only small changes were made to adapt it to the dataset used for the main pruporse of this Rmarkdown document (canalyzing cardiacn neural crist cells microaaray data from Dai et al. 2012)
